...
1. Distance calculations quantitative variables are highly influenced by variable units and magnitude. Standardize!
...
and 
$$Y = (y_1, y_2, \cdots, y_p)$$
 Both are numeric variables. We can calculate various distances as follows:
