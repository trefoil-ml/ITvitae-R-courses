...
> A more exhaustive list includes: Interactive JavaScript data visualizations based on htmlwidgets; R graphical output including base, lattice, and grid graphics; tabular data (with optional sorting, filtering, and paging); value boxes for highlighting important summary data; gauges for displaying values on a meter within a specified range; and text annotations of various l